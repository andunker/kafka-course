package com.github.andunker.kafka.tutorial4;
...
public class StreamFilterTweets {
    ...
    public static void main(String[] args) {
        ...
        properties.setProperty(StreamsConfig.APPLICATION_ID_CONFIG, "demo-kafka-streams"); // similar to consumer group but for kafka streams
