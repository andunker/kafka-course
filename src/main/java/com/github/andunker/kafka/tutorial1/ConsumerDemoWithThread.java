...
public class ConsumerDemoWithThread {
    ...
    private void run() {
        ...
        // latch for dealing with multiples threads
    ...
    public class ConsumerRunnable implements Runnable {
        ...
        final private Logger logger = LoggerFactory.getLogger(ConsumerRunnable.class.getName());
        ...
        public ConsumerRunnable(String bootstrapServers, String groupId, String topic, CountDownLatch latch) {
            ...
            consumer.subscribe(Arrays.asList(topic)); // ;consumer.subscribe(Collections.singleton(topic));
